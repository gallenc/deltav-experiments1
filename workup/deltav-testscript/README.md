...
Note that this option will remove ALL non-running containers including containers from other projects.
...
2. Copy the docker compose files from the release selected in the script
...
Once the files are downloaded ,you can start and stop the app directly from the command line using the docker compose commands:
